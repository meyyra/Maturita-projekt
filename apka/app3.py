...
def main():
    ...
    dropdown_box = pygame.Rect(220, 220, 300, 220)
    ...
    text_name = ''
    text_price = ''
    trash_icon = pygame.image.load("trash.png")  # Načte obrázek
    trash_icon = pygame.transform.scale(trash_icon, (20, 20))  # Změní velikost
    running = True
        ...
        if login_mode:
            ...
            if view_mode == "category_view":
                ...
                for product in products:
                    ...
                    screen.blit(trash_icon, (delete_button.x + 2, delete_button.y + 2))
